...
function getDemocraticPresidents(presidentsArr) {
  ...
  let Democratepresident = presidentsArr.filter((cadapresidente) => {
    if (cadapresidente.party === "Democratic") {
      return true
    } else {
      return false
    }
  })
  return Democratepresident
  }
...
function  countYearsInOffice(presidentsArr) {
      const totalYears = presidentsArr.reduce(function(acc, president) {
...
function sortedbyAge (Years1, Years2) {
  return Years1.birthYear -Years2.birthYear;
}
presidentsArr.sort(sortedbyAge)}
